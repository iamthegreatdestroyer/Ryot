...
class RyotEngine(InferenceEngine):
    ...
    def _init_attention_layers(self) -> None:
        """Initialize attention layers with loaded weights."""
        for layer_idx in range(self._config.num_hidden_layers):
            ...
            attn.q_proj = type('obj', (object,), {'shape': test_shape})()
            attn.k_proj = type('obj', (object,), {'shape': test_shape})()
            attn.v_proj = type('obj', (object,), {'shape': test_shape})()
            attn.o_proj = type('obj', (object,), {'shape': test_shape})()
